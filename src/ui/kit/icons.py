...
PATHS = {
    ...
    # Не раздел, а действие — но контур тот же и живёт там же: два стиля иконок
    # на приложение и есть та болезнь, ради которой §5 канона написан.
    # Два листа со сдвигом: узнаётся без подписи и не спорит с «листом с
    # записью» у отклонений — у того загнут угол, у этого нет.
    "copy": (
        "M9 9h9a1 1 0 011 1v9a1 1 0 01-1 1H9a1 1 0 01-1-1v-9a1 1 0 011-1z",
        "M5.5 15H5a1 1 0 01-1-1V5a1 1 0 011-1h9a1 1 0 011 1v.5",
    ),
}
