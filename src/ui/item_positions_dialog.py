...
#: Те же три слова, что в диалоге привязки: одно состояние не может называться
#: на двух экранах по-разному (долг к шву, наблюдение наряда 0014).
STATE_BOUND = "linked"
STATE_UNBOUND = "undecided"
