...
Реальные данные отклонений (WO, номера деталей, ивритские заключения) — **никогда**:
RULES §5. База автономна, не коннектится с Claude/волтом/git; парсинг детерминированный
(регулярки).
